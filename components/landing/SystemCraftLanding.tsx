...
function Footer() {
  return (
    <footer className="relative z-10 border-t border-white/[0.04] bg-[#030407] py-16">
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-[1.8fr_1fr_1fr_auto] lg:gap-8">

          {/* Brand */}
          <div>
            <Link href="/" className="flex items-center gap-3">
              <Image src="/favicon.png" alt="SystemCraft" width={32} height={32} priority />
              <span className="text-sm font-semibold tracking-wide text-white/90">SystemCraft</span>
            </Link>
            <p className="mt-4 max-w-[200px] text-xs leading-5 text-white/30">
              AI-powered system design interview simulator. Build systems. Survive failures.
            </p>
          </div>

          {/* Product */}
          <div>
            <div className="mb-4 text-[9px] font-bold uppercase tracking-[0.22em] text-white/25">Product</div>
            <ul className="flex flex-col gap-3">
              {[
                ...
                <li key={link.label}>
                  <Link href={link.href} className="text-xs text-white/40 transition-colors duration-200 hover:text-white/75">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          {/* Legal */}
          <div>
            <div className="mb-4 text-[9px] font-bold uppercase tracking-[0.22em] text-white/25">Legal</div>
            <ul className="flex flex-col gap-3">
              {[
          ...
          {/* Social */}
          <div>
            <div className="mb-4 text-[9px] font-bold uppercase tracking-[0.22em] text-white/25">Social</div>
            <div className="flex gap-2.5">
              <a
                ...
                aria-label="GitHub"
                className="flex size-8 items-center justify-center rounded-lg border border-white/[0.06] bg-white/[0.03] text-white/40 transition-all duration-200 hover:border-white/[0.14] hover:bg-white/[0.07] hover:text-white/80"
              >
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-white/[0.04] pt-8 sm:flex-row">
          ...
          <div className="font-mono text-[10px] tracking-wider text-white/15">
            Built for engineers · Portfolio project
          </div>
        </div>
      </div>
    </footer>
